...
func findThreeNumbersThatAddedGive2020(input []int) int {
	found := false
	var result int
	for i := 0; i < len(input); i++ {
		for j := 0; j < len(input); j++ {
